...
export class InitializeSchema1615794470267 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "goals_entry" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "year" integer NOT NULL DEFAULT '0', "day" integer NOT NULL DEFAULT '0', "current_calories" integer NOT NULL DEFAULT '0', "target_calories" integer NOT NULL, "current_steps" integer NOT NULL DEFAULT '0', "target_steps" integer NOT NULL, "current_floors_climbed" integer NOT NULL DEFAULT '0', "target_floors_climbed" integer NOT NULL, "current_water_litres" double precision NOT NULL DEFAULT '0', "target_water_litres" double precision NOT NULL, "current_sleep_hours" double precision NOT NULL DEFAULT '0', "target_sleep_hours" double precision NOT NULL, "userId" uuid, CONSTRAINT "PK_5e3a6bf258a670328d86f293917" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
