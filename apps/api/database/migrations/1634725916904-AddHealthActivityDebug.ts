...
export class AddHealthActivityDebug1634725916904 implements MigrationInterface {
  name = 'AddHealthActivityDebug1634725916904'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "health_activity_debug" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "processed" json, "raw" json, "log" json, "healthActivityId" uuid, "userId" uuid, CONSTRAINT "REL_9d5688a0d26e4c4e5e35055c13" UNIQUE ("healthActivityId"), CONSTRAINT "PK_19c327a2dad19a9de4e169e1203" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
