...
export default function ImportUsers() {
  ...
  const removeRow = (index) => {
    const edited = users.slice(0, index).concat(users.slice(index + 1, users.length))
    setUsers(edited)
  }
  ...
  return (
    <form onSubmit={ (e) => e.preventDefault() }>
      ...
      <code className="block">
        <pre>
          <strong>firstName,lastName,email</strong><br/>
          Daryl,Owens,d.owens@myco.com<br/>
          Derek,Clark,d.clark@myco.com<br/>
          ...
        </pre>
      </code>
