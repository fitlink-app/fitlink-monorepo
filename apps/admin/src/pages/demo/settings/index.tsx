      ...
      <div className="row mt-2">
        ...
        <div className="col-12 col-lg-6 mt-2">
          <Card className="p-3 card--stretch">
            <h3 className="h5 color-light-grey mb-3">Newsletter subscriptions</h3>
            <Checkbox
            ...
            <Checkbox
              ...
              onChange={(v) => {}}
              />
            <p className="pl-6">Receive information on app updates, new rewards, and tips to keep you inspired and motivated to achieve your wellness goals.</p>
          </Card>
        </div>
      </div>
    </Dashboard>
