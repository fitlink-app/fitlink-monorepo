import {Avatar, Label, TouchHandler} from '@components';
          ...
          <FitnessDetails>
            <View>
              ...
              <DetailView>
                <DetailInfo>
                  Distance:{' '}
                  <Label style={{color: colors.text}}>{distance} mi</Label>
                </DetailInfo>
                <DetailIcon
              ...
              <DetailView>
                <DetailInfo>
                  Speed:{' '}
                  <Label style={{color: colors.text}}>{speed} mile</Label>
                </DetailInfo>
                <DetailIcon
              ...
              <DetailView>
                <DetailInfo>
                  Time: <Label style={{color: colors.text}}>{time} m</Label>
                </DetailInfo>
                <DetailIcon
